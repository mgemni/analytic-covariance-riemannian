...
pipeline_names_lw = [
            "COV(lw)+MDM", "COV(lw)+TSP+LR", # Standard Riemannian pipelines with LW covariance estimation
            "ACOV(lw)+MDM", "ACOV(lw)+TSH+LR", # ACOV-based Riemannian pipelines with LW covariance estimation
            ]
pipeline_names_oas = [
            "COV(oas)+MDM", "COV(oas)+TSP+LR", # Standard Riemannian pipelines with OAS covariance estimation
            "ACOV(oas)+MDM", "ACOV(oas)+TSH+LR", # ACOV-based Riemannian pipelines with OAS covariance estimation
            ]

pipeline_names_lwc = [
            "COV(lw)+MDM", "COV(lw)+TSP+LR", # Standard Riemannian pipelines with LW covariance estimation
            "ACOV(lwfc)+MDM", "ACOV(lwfc)+TSH+LR", # ACOV-based Riemannian pipelines with LWC covariance estimation
            ]
pipeline_names_oasc = [
            "COV(oas)+MDM", "COV(oas)+TSP+LR", # Standard Riemannian pipelines with OAS covariance estimation
...
pipeline_groups = {"pipeline_names_no": pipeline_names_no,
                   ...
                   "pipeline_names_all": pipeline_names_all
                   }
